            ...
            with st.form("dynamic_symptom_form"):
                for q in st.session_state.questions:
                    ...
                    if q['type'] == "yes_no":
                        ...
                        st.session_state.user_answers[key] = st.number_input(q['question'], min_value=0.0, step=1.0, key=key)
                    elif q['type'] == "text":
                        st.session_state.user_answers[key] = st.text_input(q['question'], key=key)
